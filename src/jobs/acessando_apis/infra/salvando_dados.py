...
class SalvandoDados():
    ...
    def em_csv(self, caminho, dataframe):
        try:
            ...
            logging.info(f'Problemas na hora de salvar o dataframe no {caminho} em csv. Segue o erro:{error}.')
    ...
    def em_excel(self, caminho, dataframe):
        try:
            ...
            logging.info(f'Problemas na hora de salvar o dataframe no {caminho} em excel. Segue o erro:{error}.')
